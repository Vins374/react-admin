...
import { getDataItems, deleteItem } from '../../../Actions/RolesActions';
...
const Header = [
  {
    ...
    Cell: row => (
      <div>
        <input 
          name={'name'+row.original.role_id}
          id={'id'+row.original.role_id}
          type="checkbox" 
  ...
  },
  {
    ...
    Cell: row => (
        <div className="text-a-c">
            <Link to={`/tadmin/user-administration/roles/edit/${row.original.role_id}`}> <Button type="button" variant="contained" className="marginR5" color="primary"> <i className="fa fa-edit"></i> </Button> </Link>
        </div>
    )
  }
];
...
class RolesIndex extends Component {
    ...
    gotoCreate() {
      this.props.history.push('/tadmin/user-administration/roles/create');
    }
