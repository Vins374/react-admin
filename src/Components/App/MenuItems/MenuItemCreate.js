...
import { getMainMenu, createItem } from './../../../Actions/MenuItemActions';
...
class MenuItemCreate extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if(nextProps.type == 'CREATE_MENU_ITEMS') {
            if(nextProps.status){
                storeMenuItems(nextProps.data.data.menuItems);
...
export default compose(
    withStyles(classes),
    connect(mapStateToProps, { getMainMenu, createItem })
  )(MenuItemCreate);