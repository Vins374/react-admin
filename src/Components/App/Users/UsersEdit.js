...
import { editItem, getItem } from './../../../Actions/UsersActions';
        ...
        if(nextProps.type == 'USERS_ITEM') {
            if(nextProps.status)
                this.setState({ 
                                ...
                                user_status: nextProps.data.status,
                                role_id: nextProps.data.role_id, 
                            });
        }
...
export default compose(
    withStyles(classes),
    connect(mapStateToProps, { editItem, getAllRoles, getItem })
  )(UsersEdit);