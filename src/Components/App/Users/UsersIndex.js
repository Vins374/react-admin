...
import { getDataItems, deleteItem } from '../../../Actions/UsersActions';
...
const Header = [
  ...
  },
  {
    ...
    Cell: row => (
        <div className="text-a-c">
            <Link to={`/tadmin/user-administration/users/edit/${row.original.id}`}> <Button type="button" variant="contained" className="marginR5" color="primary"> <i className="fa fa-edit"></i> </Button> </Link>
        </div>
    )
  }
];
...
class UsersIndex extends Component {
    ...
    gotoCreate() {
      this.props.history.push('/tadmin/user-administration/users/create');
    }
